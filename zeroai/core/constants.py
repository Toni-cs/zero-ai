...
EXPERT_TEAM = {
    "pm": {  # 项目经理（GLM-4.7-Flash，128K 上下文，避免 GLM-4V 16K 超限）
        ...
        # PM 处理"分析/计划/翻译/通用问答"，无需图片能力；图片走 vision 专家
        "label": "项目经理·GLM-4.7",
        "model_key": "glm",
        "model": "glm-4.7-flash",
    ...
    "coder": {  # 编程专家（原 Nemotron-120B 已下线，替换为 GLM-4.7-Flash，智谱直供稳定）
        ...
        "keywords": ["代码", "编程", "函数", "bug", "error", "python", "js", "java", "css", "html",
                      ...
                      "修改", "编辑", "写入", "创建", "删除", "搜索", "查找", "项目", "仓库",
                      "配置", "json", "yaml", "xml", "toml", "ini", "env"],
    ...
    "vision": {  # 多模态（GLM-4V-Flash，智谱直供，免费多模态，稳定无中转）
        ...
        # 注意：不能用"看"/"图"等单字，否则会误匹配"查看文件"/"看代码"/"流程图"等非图片场景
        "keywords": ["图片", "截图", "看图", "看这张", "看这张图", "识别图", "图像",
                      "png", "jpg", "jpeg", "gif", "bmp", "视觉", "这张图", "这张照片"],
